...
- Rebuild the current native deck with `pitch/scripts/build_and_export_deck.sh`, which generates the editable `.pptx` and exports the `.pdf` backup from Keynote when available.
